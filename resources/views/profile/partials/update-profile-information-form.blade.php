            ...
            <div class="flex flex-col items-center mb-8 md:mb-0 md:flex-shrink-0">
                <div class="relative group">
                    <img id="preview-foto-profil"
                        ...
                        alt="Foto Profil"
                        class="w-28 h-28 md:w-32 md:h-32 rounded-full object-cover border-4 border-indigo-500 shadow-md transition-all duration-200">
        
                    <label for="foto_profil" class="absolute bottom-0 right-0 bg-yellow-50 hover:bg-yellow-100 text-yellow-700 rounded-full p-2 cursor-pointer shadow-lg transition-all duration-200 group-hover:scale-110" title="Ganti Foto Profil" style="border:2px solid #fff;">
