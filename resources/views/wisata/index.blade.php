    ...
    <div class="bg-white border-b border-gray-200" style="background-image: url('img/hero-header.jpg'); background-size: cover; background-position: center; height: fit-content;">
        <div class="max-w-7xl mx-auto px-4 py-20 sm:px-6 lg:px-8">
            <div class="text-center">
                <div class="inline-flex items-center px-3 py-1 bg-yellow-100 text-yellow-600 rounded-full text-sm font-medium mb-4">
                ...
                <h1 class="text-5xl md:text-8xl lg:text-8xl font-extrabold bg-gradient-to-r from-yellow-400 to-yellow-600 bg-clip-text text-transparent mb-4">
                ...
                <div class="grid grid-cols-3 gap-8 max-w-md mx-auto">
                    <div class="text-center">
                        <div class="text-3xl font-bold text-green-500">{{ $wisata->count() }}</div>
                        <div class="text-white font-semibold text-sm">Destinasi</div>
                    </div>
                    <div class="text-center">
                        <div class="text-3xl font-bold text-green-500">4.8</div>
                        <div class="text-white font-semibold text-sm">Rating</div>
                    </div>
                    <div class="text-center">
                        <div class="text-3xl font-bold text-green-500">100K+</div>
                        <div class="text-white font-semibold text-sm">Pengunjung</div>
                    </div>
                </div>
            </div>
        </div>
